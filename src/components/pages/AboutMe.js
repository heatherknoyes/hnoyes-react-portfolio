        ...
        <div className="about-me-content d-flex flex-wrap">
          ...
          <div className="col-12 col-md-6 col-lg-8 d-flex align-items-center">
            <p>
              ...
              Engineering. After working in the medical field professionally
              after I graduated I determined it wasn't the career I wanted.
              About four years ago I put in the work to change my career and
              became a Software Developer using the skills that I learned from
              my Computer Science minor at Georgia Tech.
              <br />
              <br />
              ...
              create this portfolio. For hobbies I love to knit, cook, bake
              bread, and host events for my friends and family. I recently moved
              back to the Atlanta area from Sarasota, Florida and am enjoying
              the cooler weather with some Appalachian trail hiking.
            </p>
          </div>
        </div>
      </section>
